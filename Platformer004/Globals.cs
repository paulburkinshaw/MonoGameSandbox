...
public static class Globals
{
    ...
    public static Rectangle GetBoundingBox(Vector2 position, Rectangle size)
    {
    ...
    public static bool PlayersCollide(Color[,] texture1, Matrix matrix1, Color[,] texture2, Matrix matrix2)
    {
