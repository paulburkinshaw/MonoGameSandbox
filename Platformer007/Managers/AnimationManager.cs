...
using System;
using Platformer007.Converters;
...
public class AnimationManager
{
    ...
    private void AddAnimation(AnimationType key, Animation animation)
    {
    ...
    private IEnumerable<Animation> GetAnimationsFromJsonFile(string jsonFile, Texture2D texture)
    {
        ...
        {
            Converters = new List<JsonConverter> { new SpritesheetJsonConverter() }
        });
