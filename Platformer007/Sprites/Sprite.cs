...
{
    public readonly Sprite CollidingSprite;
    public readonly int MovementAmount;
    public readonly float NewPosition;

    public CollidesWithSpriteEventArgs(Sprite collidingSprite, int movementAmount, float newPosition)
    {
...
public abstract class Sprite
{
        ...
        string id)
    {
        ...
        _animationManager.AnimationStarted += OnAnimationStarted;
        _animationManager.AnimationComplete += OnAnimationComplete;
    }
