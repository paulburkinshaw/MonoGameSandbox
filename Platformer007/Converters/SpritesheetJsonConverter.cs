...
namespace Platformer007.Converters
{
    public class SpritesheetData
    {
        ...
        public List<SpritesheetDataLayer> Layers { get; set; }
    }

    public class SpritesheetDataLayer
    {
    ...
    public class SpritesheetJsonConverter : JsonConverter<SpritesheetData>
    {
        public override SpritesheetData ReadJson(JsonReader reader,
            Type objectType,
            SpritesheetData existingValue,
            ...
            JsonSerializer serializer)
        {
            ...
            var layers = JsonConvert.DeserializeObject<List<SpritesheetDataLayer>>(jsonObject["meta"]["layers"].ToString());
